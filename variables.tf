...
variable "azure_log_analytics_location_override" {
  description = "Location in which to deploy resources"
  default     = ""
}
...
variable "windows_admin_username" {
  description = "Windows Administrator account (can't be administrator)"
  default     = "wadmin"
}

variable "windows_admin_password" {
  description = "Windows Administrator password (can't be your luggage combination)"
}

variable "enable_log_analytics" {
  description = "Enable Log Analytics and install on VMs"
  default     = 0
}

variable "enable_vm_diagnostics" {
  description = "Enable Diagnostics On VMs"
  default     = 0
}
